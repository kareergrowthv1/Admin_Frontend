...
export const authAPI = {
  ...
  getUserById: (id) => axios.get(`${AUTH_API_BASE_URL}/users`, { params: { id } }),
  getRolePermissions: (roleId) => axios.get(`${AUTH_API_BASE_URL}/roles/${roleId}`),
  ...
  getCollegeDetails: (organizationId) => axios.get(`/admins/college-details/${organizationId}`),
  updateCollegeDetails: (organizationId, data) => axios.put(`/admins/college-details/${organizationId}`, data),
  getCompanyDetails: (organizationId) => axios.get(`/admins/company-details/${organizationId}`),
  updateCompanyDetails: (organizationId, data) => axios.put(`/admins/company-details/${organizationId}`, data),
