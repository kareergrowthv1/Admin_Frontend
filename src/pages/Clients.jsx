        ...
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                <div className="flex items-center gap-2 text-[11px] font-semibold text-slate-400">
                    ...
                    <span className="mx-1 text-slate-200">/</span>
                    <span className="text-slate-900 font-bold uppercase">Clients</span>
                </div>
            ...
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-slate-500">Manage client profiles and contracts.</p>
                </div>
            </div>
            <div className="rounded-2xl border border-slate-100 bg-slate-50/50 p-8">
                <p className="text-slate-600">Directory of all hiring companies and points of contact.</p>
            </div>
        </div>
    );
};
