...
const IconPerson = ({ name }) => (
    <div className="w-8 h-8 rounded-full bg-slate-800 flex items-center justify-center border border-white shadow-sm overflow-hidden text-[10px] font-bold text-white uppercase">
        {name?.charAt(0) || 'C'}
    </div>
);
        ...
        return (
            <div className="min-h-screen bg-slate-50 flex items-center justify-center p-6">
                <div className="max-w-md w-full bg-white rounded-2xl border border-slate-200 p-10 text-center">
                    ...
                    <button onClick={loadReport} className="w-full bg-slate-900 text-white py-3.5 rounded-xl font-bold uppercase text-[10px] tracking-widest hover:brightness-110 active:scale-[0.98] transition-all">Reload Assessment</button>
                        ...
                        <div className="flex flex-col lg:flex-row justify-between items-center gap-12">
                            <div className="flex flex-col md:flex-row items-center gap-10">
                                <div className="flex flex-col items-center gap-4 shrink-0">
                                    {/* Avatar Circle */}
                                    <div className="w-24 h-24 md:w-32 h-32 rounded-full bg-white border-4 border-white shadow-xl flex items-center justify-center text-3xl md:text-4xl font-black text-slate-200 ring-1 ring-slate-100 select-none">
                                        {candidateName?.split(' ').map(n => n[0]).join('').toUpperCase().slice(0, 2) || 'CP'}
                                    </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
                        <section className="lg:col-span-8 space-y-8">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div className="bg-amber-50/10 border border-amber-100/50 p-6 rounded-xl">
                                    <p className="text-[10px] font-bold text-amber-600 uppercase tracking-widest mb-4 flex items-center gap-1.5"><IconAlert /> Skill Gap Observations</p>
                                    <ul className="space-y-3">
                                        {areasForImprovement.slice(0, 6).map((a, i) => (
                                            <li key={i} className="text-xs font-normal text-slate-600 leading-snug flex gap-2">
                                                <span className="text-amber-400/60">•</span> {a}
                                            </li>
                                        ))}
                                    </ul>
                                </div>
                                ...
                                return (
                                    <div key={key} className="bg-white border border-slate-100 rounded-xl p-6 shadow-sm flex flex-col h-full">
                                        ...
                                        <div className="flex-1 space-y-5">
                                            ...
                                            <div>
                                                <p className="text-[9px] font-bold uppercase text-amber-500 mb-2 text-left">Observations</p>
                        ...
                        {(screeningQuestions.generalQuestions?.length > 0 || screeningQuestions.specificQuestions?.length > 0) && (
                            <div className="space-y-16">
                                ...
                                {screeningQuestions.generalQuestions?.length > 0 && (
                                    <div className="space-y-8">
                                        <div className="bg-gradient-to-r from-[#FF6B00] to-[#FF4E00] text-white py-3.5 px-6 rounded-xl text-center font-black text-[11px] uppercase tracking-[0.25em] border border-white/10">
                                                    ...
                                                    <div className="flex justify-end w-full">
                                                        <div className="bg-white border border-slate-100 rounded-2xl p-6 sm:p-8 max-w-4xl shadow-sm space-y-4">
                                                            ...
                                                            {(q.candidateAnswer || q.answer) && q.aiComments && (
                                                                <div className="bg-orange-50/60 border border-orange-100 rounded-xl p-5 space-y-2">
                                                                    <p className="text-[9px] font-bold text-orange-400 uppercase tracking-[0.2em] flex items-center gap-2">
                                                                        <IconSparkles /> AI Analysis Reflection
                                                                    </p>
                                                                    <p className="text-[12px] font-medium text-orange-700 leading-relaxed italic">
                                                                        "{q.aiComments}"
                                                                    </p>
                                                                </div>
                                                            )}
                        ...
                        <section className="space-y-12">
                            ...
                            {codingQuestionSets.map((round, rIdx) => (
                                <div key={rIdx} className="space-y-10">
                                    <div className="bg-gradient-to-r from-[#FF6B00] to-[#FF4E00] text-white py-3.5 px-6 rounded-xl text-center font-black text-[11px] uppercase tracking-[0.25em] border border-white/10 mb-8">
                                    ...
                                    {round.questions.map((q, qIdx) => {
                                        ...
                                        return (
                                            <div key={qIdx} className="space-y-10">
                                                ...
                                                <div className="bg-[#FFFBEB] border border-amber-100 rounded-2xl shadow-sm p-8 space-y-8">
                                                    <div className="flex flex-wrap items-center justify-between gap-6">
                                                        <h5 className="text-[13px] font-bold text-amber-900/70">{candidateName || 'Candidate'}'s Solution</h5>
                                                        <div className="flex flex-wrap items-center gap-x-8 gap-y-3">
                                                            <div className="flex items-center gap-2">
                                                                <span className="text-[10px] font-bold text-amber-900/40 uppercase tracking-widest">Test Cases:</span>
                                                            ...
                                                            <div className="flex items-center gap-2">
                                                                <span className="text-[10px] font-bold text-amber-900/40 uppercase tracking-widest">Status:</span>
                                                                <span className={`text-[11px] font-bold uppercase tracking-wider ${q.executionStatus === 'SUBMITTED' ? 'text-emerald-600' : 'text-amber-600'}`}>{q.executionStatus}</span>
                                                            </div>
                                                            <div className="flex items-center gap-2">
                                                                <span className="text-[10px] font-bold text-amber-900/40 uppercase tracking-widest">Language:</span>
                                                                <span className="text-[11px] font-bold text-slate-700 uppercase">{q.language}</span>
                                                            </div>
                                                            <div className="flex items-center gap-2">
                                                                <span className="text-[10px] font-bold text-amber-900/40 uppercase tracking-widest">Time Complexity:</span>
                                                                <span className="text-[11px] font-bold text-slate-700 font-mono">{finalSubmission?.timeComplexity || 'O(n)'}</span>
                                                            </div>
                                                            <div className="flex items-center gap-2">
                                                                <span className="text-[10px] font-bold text-amber-900/40 uppercase tracking-widest">Space Complexity:</span>
                        ...
                        <section className="pt-10">
                            ...
                            <div className="mt-8 flex flex-wrap justify-center gap-4">
                                <button
                                    ...
                                    className="px-10 py-4 bg-gradient-to-r from-[#FF6B00] to-[#FF4E00] text-white rounded-xl font-black uppercase text-[11px] tracking-[0.25em] hover:shadow-lg hover:shadow-orange-500/20 active:scale-95 transition-all outline-none border border-white/10"
                                >
                                    Finalize & Export
                                </button>
                            </div>
