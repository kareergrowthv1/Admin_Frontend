                ...
                <div>
                    ...
                    <div className="flex gap-3 mb-5">
                        <PermissionWrapper feature="positions" permission={positionId ? "update" : "create"}>
                            <button
                                ...
                                className="px-6 py-2 text-xs font-bold rounded-lg bg-gradient-to-b from-blue-600 to-blue-700 text-white hover:brightness-110 transition-all flex items-center gap-2 disabled:opacity-60 disabled:cursor-not-allowed"
                            >
                                {isAISkillsLoading ? (
                    ...
                    <div className="grid grid-cols-2 gap-6 mb-5">
                        ...
                        <div>
                            ...
                            <div
                                className="w-full min-h-[36px] px-2 py-1.5 border border-slate-300 rounded-lg focus-within:ring-2 focus-within:ring-blue-500 focus-within:border-transparent bg-white shadow-[inset_0_0_2px_rgba(0,0,0,0.06)]"
                            >
                                ...
                                {form.mandatorySkills.length < 2 && (
                                    <p className="text-[11px] text-blue-600 font-medium mt-0.5">Add at least 2 mandatory skills</p>
                                )}
                            </div>
                        </div>
                    ...
                    <div className="mb-5">
                        <div className="flex items-center justify-between gap-2 mb-1.5">
                            ...
                            {positionId && position?.jobDescriptionDocumentPath && (
                                <div className="flex items-center gap-3">
                                    <button type="button" onClick={handleViewCurrentJd} className="text-xs font-medium text-blue-600 hover:underline">
                                        View
                                    </button>
                        ...
                        <>
                            ...
                            <div className="flex flex-wrap gap-2 mt-1.5 pt-2 shrink-0 border-t border-slate-100">
                                ...
                                <button
                                    ...
                                    className="px-6 py-2 text-xs font-bold rounded-lg bg-gradient-to-b from-blue-600 to-blue-700 text-white hover:brightness-110 shadow-lg shadow-blue-500/20 transition-all"
                                >
                                    Use this JD (as PDF)
                                </button>
                            </div>
